    ...
    return Container(
      ...
      child:  MaterialButton(
            ...
            child: widget.isImage ? Text(
              ...
              children: [
                        MyText(text: widget.title!,fontSize: 14.sp,color: widget.titleColor),
              widget.isSpace ? Container() :SizedBox(width: 10.w,),
              Image.asset(widget.image!,color: widget.colorImage,width: widget.widthImage,height: widget.heightImage,)
            ],),
      )
