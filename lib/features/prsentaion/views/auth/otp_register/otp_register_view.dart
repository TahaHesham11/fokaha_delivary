...
import 'package:fokaha_delivery/features/prsentaion/views/auth/otp_register/controller/otp_register_controller.dart';
          ...
          child: Column(
            children: [
              ...
              PinCodeTextField(
                ...
                appContext: context,
                length: 5,
                controller: controller.otpRegisterPhoneNumber,
                autoFocus: true,
              ...
              MyButton(onPressed: (){
                ...
                if(controller.formKey.currentState!.validate()){
                  Get.to(() =>  CreateAccountView(),preventDuplicates: false);
